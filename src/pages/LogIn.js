...
function Login() {
  ...
  return (
        ...
        <div className={styles.innerBox}>
          ...
          />
            ...
            <div className={styles.footer}>
              <p style={{color:'green',fontSize:'12px',textAlign:'right',marginTop:'-25px',marginBottom:'20px',marginRight:'10px'}} className="hover:underline">
                Forgot Password?
              </p>
      ...
      <div className="right">
          <img alt="card img" className="w-[530px] h-[658px] rounded-t float-right duration-1000 py-1 rounded-tr-[20px] rounded-br-[20px]" src={heroImg} />
      </div>
    </div>
  );
}
